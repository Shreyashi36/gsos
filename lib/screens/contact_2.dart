...
class contact_2 extends StatefulWidget {
  const contact_2({Key? key}) : super(key: key);

  @override
  State<contact_2> createState() => _contact_2();
}

class _contact_2 extends State<contact_2> {
  @override
